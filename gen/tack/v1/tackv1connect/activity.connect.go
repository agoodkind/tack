...
const (
	...
	ActivityServiceName = "tack.v1.ActivityService"
)
...
const (
	...
	// ListActivity RPC.
	ActivityServiceListActivityProcedure = "/tack.v1.ActivityService/ListActivity"
)

// ActivityServiceClient is a client for the tack.v1.ActivityService service.
...
// NewActivityServiceClient constructs a client for the tack.v1.ActivityService service. By default,
...
func NewActivityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ActivityServiceClient {
	...
	activityServiceMethods := v1.File_tack_v1_activity_proto.Services().ByName("ActivityService").Methods()
...
// ListActivity calls tack.v1.ActivityService.ListActivity.
...
// ActivityServiceHandler is an implementation of the tack.v1.ActivityService service.
...
func NewActivityServiceHandler(svc ActivityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tack.v1.ActivityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedActivityServiceHandler) ListActivity(context.Context, *connect.Request[v1.ListActivityRequest]) (*connect.Response[v1.ListActivityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ActivityService.ListActivity is not implemented"))
}
