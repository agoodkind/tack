...
const (
	...
	ProjectServiceName = "tack.v1.ProjectService"
)
...
const (
	...
	// CreateProject RPC.
	ProjectServiceCreateProjectProcedure = "/tack.v1.ProjectService/CreateProject"
	// ProjectServiceGetProjectProcedure is the fully-qualified name of the ProjectService's GetProject
	// RPC.
	ProjectServiceGetProjectProcedure = "/tack.v1.ProjectService/GetProject"
	// ProjectServiceListProjectsProcedure is the fully-qualified name of the ProjectService's
	// ListProjects RPC.
	ProjectServiceListProjectsProcedure = "/tack.v1.ProjectService/ListProjects"
	// ProjectServiceUpdateProjectProcedure is the fully-qualified name of the ProjectService's
	// UpdateProject RPC.
	ProjectServiceUpdateProjectProcedure = "/tack.v1.ProjectService/UpdateProject"
	// ProjectServiceDeleteProjectProcedure is the fully-qualified name of the ProjectService's
	// DeleteProject RPC.
	ProjectServiceDeleteProjectProcedure = "/tack.v1.ProjectService/DeleteProject"
)

// ProjectServiceClient is a client for the tack.v1.ProjectService service.
...
// NewProjectServiceClient constructs a client for the tack.v1.ProjectService service. By default,
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_tack_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// CreateProject calls tack.v1.ProjectService.CreateProject.
...
// GetProject calls tack.v1.ProjectService.GetProject.
...
// ListProjects calls tack.v1.ProjectService.ListProjects.
...
// UpdateProject calls tack.v1.ProjectService.UpdateProject.
...
// DeleteProject calls tack.v1.ProjectService.DeleteProject.
...
// ProjectServiceHandler is an implementation of the tack.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/tack.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) CreateProject(context.Context, *connect.Request[v1.CreateProjectRequest]) (*connect.Response[v1.Project], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ProjectService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.Project], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ProjectService.GetProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) ListProjects(context.Context, *connect.Request[v1.ListProjectsRequest]) (*connect.Response[v1.ListProjectsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ProjectService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) UpdateProject(context.Context, *connect.Request[v1.UpdateProjectRequest]) (*connect.Response[v1.Project], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ProjectService.UpdateProject is not implemented"))
}
...
func (UnimplementedProjectServiceHandler) DeleteProject(context.Context, *connect.Request[v1.DeleteProjectRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tack.v1.ProjectService.DeleteProject is not implemented"))
}
